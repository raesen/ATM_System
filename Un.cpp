...
#include<stdlib.h>		//standard library, system("cls") 
#include<conio.h>		//getch function
#include<dos.h>			//delay function
#include<windows.h>		//Sleep, gotoxy functions
...
void gotoxy (int x, int y);	//handle output on screen / palce cursor at desired coordinates
...
void scroll_note()	//welcome note
{
	...
	gotoxy(27,13);cout<<"MSRIT ATM SERVICES";
	...
	gotoxy(56,23);cout<<"Rahul   160114737050";
	gotoxy(56,24);cout<<"Shubham 160114737051";
	Sleep(2000);
...
void machine::help()		//initial help notice in mainmenu on opening account
{
	...
	gotoxy(3,24);
	cout<<"Contact at rahulsundriyal.blogspot.ins";
...
void machine::note()	//final !!!
{
	...
	cout<<"CONTACT US AT : RAHULSUNDRIYAL122@GMAIL.COM";gotoxy(24,18);
